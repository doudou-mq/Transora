 ...
 *   设计稿 v1.0 ｜ 产品版本 = manifest.version = 0.1.0 ｜ manifest_version = 3。
...
const CHANGELOG: Array<[string, string, string]> = [
  [
    `v${PRODUCT_VERSION} · 2026-09-10`,
    '当前版本',
    '首个版本：整页双语对照（含 Sticky 状态栏与工具栏角标）、恢复原文、划词翻译、侧边栏多模型对比（G6）、'
      + '多模型配置、新标签页（模型配置 / 通用设置 / 翻译历史 / 关于 Transora）。',
  ],
  [
    '规划中',
    '阶段 2',
    // G6 已于 2026-09-17 落地（侧边栏「多模型对比」Tab），不再列在「规划中」，否则与菜单里已开放的入口自相矛盾
    '翻译历史的搜索筛选与导出（F1–F5）、SPA 动态补翻。',
  ],
]
